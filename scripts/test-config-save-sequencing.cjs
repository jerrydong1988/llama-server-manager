...
const configContextSource = fs.readFileSync(
  path.join(__dirname, '..', 'src', 'components', 'ConfigPage', 'ConfigContextSummary.tsx'),
  'utf8',
)
...
assert.match(configContextSource, /message\.tone === 'amber'[\s\S]*bg-sky-50/)
