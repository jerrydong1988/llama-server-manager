...
export function getConfigPageLabels(lang: string) {
  ...
  return {
    ...
    deploymentIdentityBlockedHint: zh ? '请刷新模型和引擎清单、完成引擎资格认证，并保存当前配置。' : 'Refresh model and engine inventories, complete engine qualification, and save the current configuration.',
