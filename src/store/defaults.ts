...
export function defaultInstanceConfig(): InstanceConfig {
  return {
    ...
    reasoning_format: '', reasoning_effort: '', reasoning: '', reasoning_preserve: '',
    ...
    warmup: true, ctx_checkpoints: 32, checkpoint_min_step: 8192,
    swa_full: false,
    ...
    flash_attn: 'auto', moe_cpu_layers: 0, cpu_moe: false, load_mode: '', lazy_mode: '', mlock: false,
    ...
    log_prompts_dir: '', slot_prompt_similarity: 0.1, prefill_assistant: true,
    models_dir: '', models_preset: '', models_max: 4, models_autoload: true,
    mmproj_url: '', mmproj_auto: false, mmproj_mode: '', no_mmproj: false, no_mmproj_offload: false, image_min_tokens: 0, image_max_tokens: 0, mtmd_batch_max_tokens: 1024,
