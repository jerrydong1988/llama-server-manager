...
pub fn object_subclass(_attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    match syn::parse::<syn::ItemImpl>(item) {
        ...
        Err(_) => return syn::Error::new(proc_macro2::Span::call_site(), object_subclass_attribute::WRONG_PLACE_MSG).to_compile_error().into(),
    }
}
...
pub fn object_interface(_attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    match syn::parse::<syn::ItemImpl>(item) {
        ...
        Err(_) => return syn::Error::new(proc_macro2::Span::call_site(), object_interface_attribute::WRONG_PLACE_MSG).to_compile_error().into(),
    }
}
...
pub fn derived_properties(_attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    match syn::parse::<syn::ItemImpl>(item) {
        ...
        Err(_) => return syn::Error::new(proc_macro2::Span::call_site(), derived_properties_attribute::WRONG_PLACE_MSG).to_compile_error().into(),
    }
}
